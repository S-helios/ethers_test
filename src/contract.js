...
const provider = new ethers.JsonRpcProvider(`https://mainnet.infura.io/v3/${process.env.INFURA_ID}`)
...
// console.log(await contractEth.getDeployedCode());
...
console.log(contractDAI.addressWETH);